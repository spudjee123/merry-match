    ...
    const fetchData = async () => {
      try {
        ...
        const users = result.data.data.map((user) => ({
          ...
          city: user.city,
          sexident: user.sexident,
          sexprefer: user.sexprefer,
          racialprefer: user.racialprefer,
          meetprefer: user.meetprefer,
                      ...
                      <div className="">
                        ...
                        <p className="flex flex-row text-[20px]">
                          <img
                            ...
                            alt="Location icon"
                          />
                          {userData[currentIndex].city},{" "}
                          {userData[currentIndex].location}
                        </p>
                      </div>
                      <SeeProfile profile={userData[currentIndex]} />
                    </div>
