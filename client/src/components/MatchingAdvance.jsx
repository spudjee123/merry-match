...
//     name: "Dinesh Chugtai",
//     url: dinesh,
//     nextUrl: richard, // For looping purposes, you can use the first one again or leave it undefined
//   },
// ];
...
//                   <div className="w-[90%] h-full flex flex-row items-end justify-between">
//                     <h3 className="text-white text-[25px] flex justify-center items-center">
//                       <div className="">{person.name} 24</div>
//                       <button className="mt-2">
//                         <img src={SeeProfile} className="w-[60px] h-[60px]" />
//                       </button>
//                     </h3>
...
//                     <div className="w-[90%] h-full flex flex-row items-end justify-between">
//                       <h3 className="text-white text-[18px] flex justify-center items-center">
//                         <div className="">
//                           Next:{" "}
//                           <img
//                             src={person.nextUrl}
