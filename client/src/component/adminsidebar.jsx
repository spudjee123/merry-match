    ...
    <div className="w-full md:w-[15%] min-h-screen bg-white border-r border-gray-300 flex-col justify-start items-start gap-10 inline-flex">
      ...
      <a href="#">
          <div className="p-6 bg-white justify-start items-start gap-4 inline-flex">
            <div className="h-6 w-6 md:h-8 md:w-8 flex justify-center items-center"><img src={Box} alt="Box Icon" className="w-full h-full" /></div>
            <div className="text-slate-600 text-sm md:text-base">Merry Package</div>
          </div>
        </a>
        <a href="#">
          <div className="w-full p-6 bg-white justify-start items-start gap-4 inline-flex">
            <div className="h-6 w-6 md:h-8 md:w-8 flex justify-center items-center"><img src={Vector} alt="Vector Icon" className="w-full h-full" /></div>
